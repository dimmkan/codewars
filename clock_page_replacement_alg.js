...
function clock(n, referenceList) {
  ...
  for (let i = 0; i < referenceList.length; i++) {
    ...
    if (index !== -1) {
      ...
      while (rBits[iterator] === 1) {
        rBits[iterator] = 0;
        iterator = (iterator + 1) % n;
      }
      memory[iterator] = page;
      iterator = (iterator + 1) % n;
    }
  }
