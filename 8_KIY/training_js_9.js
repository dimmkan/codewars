/*
f you want your code to do a lot of similar work, a loop statement is a good choice. For example, if we need to calculate the cumulative value from 1 to 10, we can write code like this:
...
//const padIt = (str,n) => [...Array.from({length: n}, v => '*')].reduce((acc, item, index) => index % 2 ? acc + item : item + acc, str);
