...
const sectSort = (array, start, length) => [...array.slice(0, start), ...(length ? [...array.slice(start, start + length).sort((a, b) => a - b), ...array.slice(start + length)] : [...array.slice(start).sort((a, b) => a - b)])];